    ...
    <div class="container-fluid">
        <div class="row">
			...
			<form action="" method="post">
				...
				<input type="text" name="nik" id="nik" class="form-control" required><br><br>
			
				<label for="nama_karyawan">Nama :</label>
				<input type="text" name="nama_karyawan"  class="form-control" id="nama_karyawan"><br><br>
			
				<label for="area">Area :</label>
				<input type="text" name="area"  class="form-control" id="area"><br><br>
			
				<label for="plotting">Plotting :</label>
				<input type="text" name="plotting"  class="form-control" id="plotting"><br><br>
